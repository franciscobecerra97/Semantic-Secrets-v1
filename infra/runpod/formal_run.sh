...
common=(
  ...
  --opportunities /workspace/data/support_opportunities_v3_1.csv
  ...
  --authorization /workspace/environment/formal_authorization_v3_1.json
  --annotation /workspace/environment/annotation_resource_v3_1.json
