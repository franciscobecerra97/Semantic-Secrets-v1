...
This package prepares—but does not authorise—the frozen P9-v3B capability execution. It contains no weights, capability images, annotations, thresholds, or experimental outputs. The active contract is the composition of the immutable v3.0 files and prospective v3.1 amendment.
...
See [ANNOTATION.md](ANNOTATION.md) for the model-blind data procedure, [RUNBOOK.md](RUNBOOK.md) for the guarded sequence, and [SHUTDOWN_CHECKLIST.md](SHUTDOWN_CHECKLIST.md) before terminating a Pod.
