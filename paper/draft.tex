...
This blueprint treats visual generation as a testable reconstruction layer, not a source of magical entropy, and treats privacy as a construction-specific property, not a consequence of hashing semantics. P8 passed Gate V2-N with narrowed claims and a frozen preregistration. The next permitted work is P9 representation capability and independent reconstruction; no v2 model output, dataset result, authentication result, or cryptographic prototype yet exists.
